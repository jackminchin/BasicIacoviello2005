...
parameters BETA, T_BETA, j, m, GAMMA, X, ETA, RHO, PHIP, PHIY, OMEGA, KTILDE, J_ss, PP;
BETA=0.99;
T_BETA=0.98;
J_ss=0.1;
X=1.2;
...
stoch_simul(order=1, irf=20, nograph) Y C dp Cu Cc Hu Hc q A R bc J;