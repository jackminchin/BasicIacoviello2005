...
if T_flag
    T = basic_IAC_LV09.static_g1_tt(T, y, x, params);
end
g1 = zeros(17, 17);
g1(1,1)=(-exp(y(1)))/(exp(y(1))*exp(y(1)))-T(14);
...
g1(6,16)=1/exp(y(8));
g1(7,16)=1;
g1(8,5)=(-(exp(y(12))*exp(y(9))*params(15)*(-(exp(y(5))*exp(y(8))*params(4)))/(exp(y(5))*exp(y(5)))));
g1(8,6)=exp(y(6));
g1(8,8)=(-T(7));
g1(8,9)=(-T(7));
g1(8,12)=(-T(7));
g1(9,3)=(-(exp(y(17))*T(9)*T(15)));
g1(9,4)=(-(exp(y(17))*T(8)*T(16)));
g1(9,13)=exp(y(13));
g1(9,17)=(-(exp(y(17))*T(8)*T(9)));
g1(10,3)=(-(T(12)*T(9)*params(5)*exp((-y(17)))*exp(y(3))*getPowerDeriv(exp(y(3)),params(5)-1,1)));
g1(10,4)=(-(T(12)*T(11)*T(16)));
g1(10,10)=exp(y(10));
g1(10,15)=(-(T(9)*T(11)*(-exp(y(15)))/(exp(y(15))*exp(y(15)))));
g1(10,17)=(-(T(12)*T(9)*T(10)*params(5)*(-exp((-y(17))))));
g1(11,3)=(-(T(12)*T(13)*exp(y(17))*params(5)*T(15)));
g1(11,4)=(-(T(12)*T(8)*exp(y(17))*params(5)*exp(y(4))*getPowerDeriv(exp(y(4)),(-params(5)),1)));
g1(11,11)=exp(y(11));
g1(11,15)=(-(T(8)*exp(y(17))*params(5)*T(13)*(-exp(y(15)))/(exp(y(15))*exp(y(15)))));
g1(11,17)=(-(T(12)*T(8)*exp(y(17))*params(5)*T(13)));
g1(12,17)=0.2;
g1(13,12)=1-params(1);
g1(13,15)=params(12);
g1(14,5)=1-params(8);
