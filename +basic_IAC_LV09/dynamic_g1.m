...
if T_flag
    T = basic_IAC_LV09.dynamic_g1_tt(T, y, x, params, steady_state, it_);
end
g1 = zeros(17, 29);
...
g1(6,24)=(-(T(15)-params(2)*(1-params(4))*exp(y(24))/exp(y(23))));
g1(6,25)=(-T(15));
g1(6,20)=1/exp(y(12));
g1(7,20)=1;
g1(7,26)=(-1);
g1(8,9)=(-(exp(y(25))*exp(y(24))*(-(exp(y(9))*exp(y(12))*params(4)))/(exp(y(9))*exp(y(9)))));
g1(8,10)=exp(y(10));
g1(8,12)=(-T(6));
g1(8,24)=(-T(6));
g1(8,25)=(-T(6));
g1(9,7)=(-(exp(y(21))*T(8)*T(13)));
g1(9,8)=(-(exp(y(21))*T(7)*T(14)));
g1(9,17)=exp(y(17));
g1(9,21)=(-(exp(y(21))*T(7)*T(8)));
g1(10,7)=(-(T(10)*T(8)*params(5)*exp(y(7))*getPowerDeriv(exp(y(7)),params(5)-1,1)));
g1(10,8)=(-(T(10)*T(9)*T(14)));
g1(10,14)=exp(y(14));
g1(10,19)=(-(T(8)*T(9)*(-exp(y(19)))/(exp(y(19))*exp(y(19)))));
g1(11,7)=(-(T(10)*T(11)*params(5)*T(13)));
g1(11,8)=(-(T(10)*params(5)*T(7)*exp(y(8))*getPowerDeriv(exp(y(8)),(-params(5)),1)));
g1(11,15)=exp(y(15));
g1(11,19)=(-(params(5)*T(7)*T(11)*(-exp(y(19)))/(exp(y(19))*exp(y(19)))));
g1(12,4)=(-0.8);
g1(12,21)=1;
g1(12,29)=(-1);
g1(13,16)=1;
